    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sm4encBT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //解密
                byte[] s = cto.sm4Dec(Base64.decode(b64SM4EncMsg,Base64.DEFAULT),Base64.decode(b64SM4EncMsg,Base64.DEFAULT).length ,CDRIVES );
                Log.i("younger" , "解密"+ new String(s));
                Log.i("younger" , "解密"+ Base64.decode(b64SM4EncMsg,Base64.DEFAULT).length);
                Log.i("younger" , "解密"+ cto.verification(MainActivity2.this));
            }
        });
